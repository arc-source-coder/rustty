...
unsafe extern "C" {
    pub fn ghostty_vt_terminal_new(cols: u16, rows: u16) -> *mut c_void;
    pub fn ghostty_vt_terminal_free(terminal: *mut c_void);
    ...
    pub fn ghostty_vt_terminal_feed(terminal: *mut c_void, bytes: *const u8, len: usize) -> c_int;

    pub fn ghostty_vt_terminal_resize(terminal: *mut c_void, cols: u16, rows: u16) -> c_int;
    ...
    pub fn ghostty_vt_terminal_render_cursor(terminal: *mut c_void, out: *mut CursorState)
    -> c_int;
    pub fn ghostty_vt_terminal_render_colors(terminal: *mut c_void, out: *mut ColorState) -> c_int;
