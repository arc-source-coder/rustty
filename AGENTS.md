...
2. `crates/ghostty-vt/zig/ghostty` - The Ghostty source code (latest - version 1.3 using Zig 0.15.2). Inspiration for UI / feature design, architecture, and data models. Vendored as a submodule.
